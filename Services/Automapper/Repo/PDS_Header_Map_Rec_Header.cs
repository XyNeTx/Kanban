...
{
    //public class PDS_Header_Map_Rec_Header : AutoMapRepo<TB_PDS_Header, TB_REC_HEADER>, IPDS_Header_Map_Rec_Header
    //{
    //    private readonly IMapper _mapper;
    //    public PDS_Header_Map_Rec_Header(IMapper mapper) : base(mapper)
    //    {
    //        _mapper = mapper;
    //    }
    //}
