...
$(document).ready(function () {
    ...
    xAjax.onClick("#ReportBtn", function () {
        ...
        //window.location.href = reportUrl + 'KBNRC150' + '?DateFrom=' + devDate + '&DateTo=' + toDate +
        //    '&PartFrom=' + partFrom + '&PartTo=' + partTo + '&UserName=' + userName;
        window.open(_REPORTINGSERVER_ + '%2fKB3%2f' + 'KBNRC150' + '&rs:Command=Render'
            + '&DateFrom=' + devDate
            + '&DateTo=' + toDate
            + '&PartFrom=' + partFrom
            + '&PartTo=' + partTo
            + '&UserName=' + userName, '_blank');
    });
});
