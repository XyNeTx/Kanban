...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get('/api/KBNIM007N/GetSupplier', '', function (success) {
...
$(document).on("click", "#chkBoxHeadID", function () {
    return __awaiter(this, void 0, void 0, function* () {
        if ($(this).is(":checked")) {
...
$("#buttonInq").click(function () {
    ...
    _xLib.AJAX_Get('/api/KBNIM007N/Inquiry', '', function (success) {
        if (success.status === "200") {
            $("#txtOrderNo").remove();
...
$(document).on("change", "#txtOrderNo", function () {
    if (_command === 'Inquiry') {
        _xLib.AJAX_Get('/api/KBNIM007N/OrderNoSelected', { F_PDS_No: $("#txtOrderNo").val().trim() }, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                if (success.status === "200") {
                    success.data = JSON.parse(success.data);
                    success.data = _xLib.TrimJSON(success.data);
                    console.log(success.data);
                    yield $("#selectSupplier").val(success.data[0].F_Supplier_CD + "-" + success.data[0].F_Supplier_Plant);
...
$("#buttonNew").click(function () {
    ...
    $("#buttonUpd").prop("disabled", true);
    $("#buttonDel").prop("disabled", true);
    _xLib.AJAX_Get('/api/KBNIM007N/GenPDSNo', '', function (success) {
        if (success.status === "200") {
...
$(document).on('change', "#selectSupplier , #inputDeliveryDate", function () {
    ...
    _xLib.AJAX_Get('/api/KBNIM007N/GetPartNo', { F_Supplier_Cd: $("#selectSupplier").val() }, function (success) {
        if (success.status === "200") {
            $("#inputPartNo").empty();
...
$("#inputPartNo, #inputKanbanNo").change(function () {
    ...
    _xLib.AJAX_Get('/api/KBNIM007N/PartNoChanged', obj, function (success) {
        if (success.status === "200") {
            success.data = JSON.parse(success.data);
            _xLib.TrimJSON(success.data);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (_command === 'New') {
                ...
                return yield OkClicked(_arrObj);
            }
                ...
                _arrObj.forEach(function (item, i) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield _xLib.AJAX_Post('/api/KBNIM007N/Update', JSON.stringify(item), function (success) {
                            if (success.status === "200") {
                ...
                xSwal.question("Confirm !!", "Are you sure to delete data?", function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield _xLib.AJAX_Post('/api/KBNIM007N/Delete', JSON.stringify(_Obj), function (success) {
                            if (success.status === "200") {
                                console.log("Success: ", success);
                                if ($("input[name='inputChkBox']:checked").length > 0) {
                                    $("#table").DataTable().clear().draw();
...
function OkClicked(_arrObj, isImport) {
    return __awaiter(this, void 0, void 0, function* () {
        //return console.log(_arrObj);
        for (const item in _arrObj) {
            if (yield _arrObj[item].hasOwnProperty("F_Delivery_Date")) {
            ...
            yield _xLib.AJAX_Post('/api/KBNIM007N/OKClicked', _json, function (success) {
                if (success.status === "200") {
                    console.log("Success: ", success);
                    if ($("input[name='inputChkBox']:checked").length > 0) {
        ...
        yield _xLib.AJAX_Get('/api/KBNIM007N/AllDataWasSaved', { F_PDS_No: PDS_No }, function (success) {
            if (success.status === "200") {
...
$("#buttonImport").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!_File.length)
            return xSwal.error("Error !!", "No file selected.");
        const file = _File[0];
        ...
        return yield OkClicked(_arrObj, true);
    });
});
