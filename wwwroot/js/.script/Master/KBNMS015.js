...
$("#divBtn").on("click", "button", function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield $(this).prop("disabled", false);
        //console.log("click 1");
...
function ImportFile(_files) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log(data);
            _xLib.AJAX_Post("/api/KBNMS015/Save?action=imp", data, function (success) {
                GetListData();
...
function GetDropDown() {
    ...
    _xLib.AJAX_Get("/api/KBNMS015/GetDropDown", obj, function (success) {
...
function SupplierChanged() {
    ...
    _xLib.AJAX_Get("/api/KBNMS015/SupplierChanged", obj, function (success) {
        //success = _xLib.JSONparseMixData(success);
...
function PartNoSelected() {
    ...
    _xLib.AJAX_Get("/api/KBNMS015/PartNoSelected", obj, function (success) {
        success = _xLib.JSONparseMixData(success);
        console.log(success);
...
function GetListData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get("/api/KBNMS015/GetListData", obj, function (success) {
            success = _xLib.JSONparseMixData(success);
            console.log(success);
...
function Save() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        obj.F_Cycle = yield obj.F_Cycle.replace(/-/g, "");
        yield listObj.push(obj);
        ...
        if (action.toLowerCase() == "inq")
            return xSwal.error("Error", "Action Command is invalid");
        _xLib.AJAX_Post("/api/KBNMS015/Save?action=" + action, listObj, function (success) {
            GetListData();
            xSwal.success(success.response, success.message);
        }, function (error) {
            xSwal.xError(error);
