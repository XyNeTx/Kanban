    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ($(this).attr("id") == "btnUpd") {
            ...
            if ($(document).find("input[id='F_Short_Logistic']").length == 0) {
                yield $("select[name='F_Short_Logistic']").parent().remove();
            ...
            `);
                yield $("select[name='F_Supplier_CD']").parent().remove();
            ...
            `);
                yield $("select[name='F_Short_Name']").parent().remove();
...
$("#btnCan").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        if ($(document).find("select[name='F_Short_Logistic']").length == 0) {
            yield $("input[name='F_Short_Logistic']").remove();
            $("label[for='F_Short_Logistic']").parent().append(`
        ...
        `);
            yield $("input[name='F_Supplier_CD']").remove();
            $("label[for='F_Supplier_CD']").parent().append(`
        ...
        `);
            yield $("input[name='F_Short_Name']").remove();
            $("label[for='F_Short_Name']").parent().append(`
...
function GetShortLogistic() {
    return __awaiter(this, void 0, void 0, function* () {
        _xLib.AJAX_Get('/api/KBNMS027/GetShortLogistic', null, function (success) {
...
function GetShortName() {
    return __awaiter(this, void 0, void 0, function* () {
        _xLib.AJAX_Get('/api/KBNMS027/GetShortName', null, function (success) {
            success.data = _xLib.TrimArrayJSON(success.data);
...
function GetListData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get('/api/KBNMS027/GetListData', data, function (success) {
            success.data = _xLib.TrimArrayJSON(success.data);
            console.log(success);
...
function SupOrderSelected() {
    return __awaiter(this, void 0, void 0, function* () {
        let data = {
            F_Short_Name: $("#F_Short_Name").val(),
        };
        _xLib.AJAX_Get('/api/KBNMS027/SupOrderSelected', data, function (success) {
            success.data = _xLib.TrimArrayJSON(success.data);
            console.log(success);
...
function Save() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Post('/api/KBNMS027/Save?action=' + action, listData, function (success) {
            console.log(success);
            success.data = _xLib.TrimArrayJSON(success.data);
