...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield GetStore();
        yield GetPartNo();
        yield $(".SelectPicker").selectpicker();
        yield prependDateLabel();
        xSplash.hide();
    });
});
...
function GetSupplier() {
    return __awaiter(this, void 0, void 0, function* () {
        yield _xLib.AJAX_Get("/api/KBNMS006/GetSupplier", '', function (success) {
...
function GetPartNo() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS006/GetPartNo", F_Store_Code, function (success) {
            if (success.status == 200) {
                $("#selectPartNo").empty();
...
function GetKanban(F_Supplier_Code) {
    return __awaiter(this, void 0, void 0, function* () {
        yield _xLib.AJAX_Get("/api/KBNMS006/GetKanban", F_Supplier_Code, function (success) {
            if (success.status == 200) {
                $("#selectKanban").empty();
...
function GetStore() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS006/GetStore", F_Part_No, function (success) {
            if (success.status == 200) {
                $("#selectStore").empty();
...
$("#selectSupplier").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var F_Store_Code = { F_Store_Code: $("#selectStore").val() == null ? "" : $("#selectStore").val() };
        yield GetKanban(F_Supplier_Code);
        yield $("#selectKanban").selectpicker("refresh");
        //get supplier detail
        var obj = {
...
$("#selectPartNo").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield GetStore();
        yield $("#selectStore").selectpicker("refresh");
    });
});
$("#selectStore").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield GetPartNo();
        yield $("#selectPartNo").selectpicker("refresh");
    });
});
$("#selectKanban").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get("/api/KBNMS006/GetKanbanDetail", obj, function (success) {
            if (success.status == 200) {
...
$("#btnSearch").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS006/Search", obj, function (success) {
            if (success.status == 200) {
                ...
                if (success.data.chgQty == null) {
                    ...
                    $("#boxStatus").val(success.data.chgQty.f_Status == 0 ? "0 : None" :
                ...
                if (success.data.stop == null) {
                    ...
                    $("#stopStatus").val(success.data.stop.f_Status == 0 ? "0 : None" :
                ...
                if (success.data.cut == null) {
                    ...
                    $("#cutStatus").val(success.data.cut.f_Status == 0 ? "0 : None" :
        ...
        _xLib.AJAX_Get("/api/KBNMS006/GetDeliveryTime", { F_Supplier_Code: obj.F_Supplier_Code }, function (success) {
            if (success.status == 200) {
...
$("#btnSaveKB").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to save Kanban Master data?");
        if (!isConfirm) {
            return;
        }
        var TB_MS_Kanban = {
        ...
        _xLib.AJAX_Post("/api/KBNMS006/SaveKanban", JSON.stringify(TB_MS_Kanban), function (success) {
            if (success.status == 200) {
...
$("#boxBtnSave").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to SAVE Kanban Box Change data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/SaveBoxQtyChg", JSON.stringify(GetTB_Kanban_Chg()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#boxBtnStart").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to START Kanban Box Change data?");
        if (!isConfirm) {
            return;
        }
        var obj = GetTB_Kanban_Chg();
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/StartBoxQtyChg", JSON.stringify(obj), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#boxBtnStop").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to STOP Kanban Box Change data?");
        if (!isConfirm) {
            return;
        }
        var obj = GetTB_Kanban_Chg();
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/StopBoxQtyChg", JSON.stringify(obj), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#stopBtnSave").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to SAVE Kanban Stop data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/SaveKBStop", JSON.stringify(Get_Kanban_Stop()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#stopBtnStart").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to START Kanban Stop data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/StartKBStop", JSON.stringify(Get_Kanban_Stop()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#stopBtnStop").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to STOP Kanban Stop data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/StopKBStop", JSON.stringify(Get_Kanban_Stop()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#cutBtnSave").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to SAVE Kanban Cut data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/SaveKBCut", JSON.stringify(Get_Kanban_Cut()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#cutBtnStart").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to START Kanban Cut data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/StartKBCut", JSON.stringify(Get_Kanban_Cut()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
...
$("#cutBtnStop").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var isConfirm = yield xSwal.confirm("Confirm", "Do you sure to STOP Kanban Cut data?");
        if (!isConfirm) {
            return;
        }
        //console.log(TB_Kanban_Chg)
        _xLib.AJAX_Post("/api/KBNMS006/StopKBCut", JSON.stringify(Get_Kanban_Cut()), function (success) {
            if (success.status == 200) {
                $("#btnSearch").trigger("click");
                xSwal.success(success.title, success.message);
            }
