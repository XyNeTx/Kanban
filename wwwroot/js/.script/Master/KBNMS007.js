...
$("#btnSearch").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS007/Search", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                if (success.status == 200) {
                    success = _xLib.JSONparseMixData(success);
                    console.log(success);
                    if (!success.data) {
                        yield $("#divTrip").find("input").val("");
                        yield $("#divAddCycle").find("input").val("");
                        yield $("#divStatus").find("input").val("");
...
$("#btnSave").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = yield GetKanbanAddObj();
        //console.log(obj);
        if (yield xSwal.confirm("Confirm", "Do you sure to save data?")) {
            _xLib.AJAX_Post("/api/KBNMS007/Save", JSON.stringify(obj), function (success) {
                if (success.status == 200) {
                    xSwal.success(success.title, success.message);
...
$("#btnStart").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = yield GetKanbanAddObj();
        if (yield xSwal.confirm("Confirm", "Do you sure to start?")) {
            _xLib.AJAX_Post("/api/KBNMS007/Start", JSON.stringify(obj), function (success) {
                if (success.status == 200) {
                    xSwal.success(success.title, success.message);
                    $("#btnSearch").trigger("click");
                }
...
$("#btnStop").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = yield GetKanbanAddObj();
        if (yield xSwal.confirm("Confirm", "Do you sure to stop?")) {
            _xLib.AJAX_Post("/api/KBNMS007/Stop", JSON.stringify(obj), function (success) {
                if (success.status == 200) {
                    xSwal.success(success.title, success.message);
                    $("#btnSearch").trigger("click");
                }
...
$("#btnCancelBottom").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield SetInputReset();
        $("#btnSearch").trigger("click");
    });
