...
function GetSupplier() {
    return __awaiter(this, void 0, void 0, function* () {
        yield _xLib.AJAX_Get("/api/KBNMS008/GetSupplier", "", function (success) {
...
function GetKanban() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS008/GetKanban", obj, function (success) {
            if (success.status == "200") {
...
function GetStore() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS008/GetStore", obj, function (success) {
            if (success.status == "200") {
                $("#selectStore").empty();
                $("#selectStoreTo").empty();
                success.data.forEach(function (item) {
...
function GetPartNo() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS008/GetPartNo", obj, function (success) {
            if (success.status == "200") {
                $("#selectPart").empty();
                $("#selectPartTo").empty();
                success.data.forEach(function (item) {
...
$("#selectSupplier").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get("/api/KBNMS008/GetSupplierDetail", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                if (success.status == "200") {
                    //console.log(success.data);
        ...
        yield $("#selectKanban").val("");
        yield $("#selectKanbanTo").val("");
        yield $("#selectStore").val("");
        yield $("#selectStoreTo").val("");
        yield $("#selectPart").val("");
        yield $("#selectPartTo").val("");
        yield GetKanban();
        yield GetStore();
        yield GetPartNo();
    });
...
$("#selectKanban , #selectKanbanTo").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        if ($(this).val() == "") {
            return;
        }
...
$("#selectStore , #selectStoreTo").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
...
$("#selectPart , #selectPartTo").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        if ($(this).val() == "") {
            return;
        }
...
$("#selectDate").change(function () {
    ...
    _xLib.AJAX_Post("/api/KBNMS008/SelectDateChange", JSON.stringify(Obj), function (success) {
        return __awaiter(this, void 0, void 0, function* () {
            if (success.status == "200") {
...
function ShowData() {
    ...
    if (selectDate == moment($("#selectDate").val(), "DD/MM/YYYY").format("YYYYMMDD"))
        return;
    xSplash.show();
    selectDate = obj.selDate;
    //let listColor = ["#FFBF00","#7DF9FF" ]
    //let listRowColor = ["#FFFFFF", "FF3131"];
    _xLib.AJAX_Get("/api/KBNMS008/Show_Data", obj, function (success) {
        if (success.status == "200") {
            //console.log(success.data);
...
$("#btnSearch").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNMS008/Search", obj, function (success) {
            if (success.status == "200") {
...
$("#btnConfirm").click(function () {
    ...
    _xLib.AJAX_Post("/api/KBNMS008/UpToList", JSON.stringify(data), function (success) {
        if (success.status == "200") {
...
$("#btnImport").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield _xLib.AJAX_Get("/api/KBNMS008/GetSupplierDetail", obj, function (success) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (success.status == "200") {
                        //console.log(success.data);
                        $("#readSupplier").val(obj.supplier);
            ...
            yield _xLib.AJAX_Post("/api/KBNMS008/GetImportList", JSON.stringify(_json), function (success) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (success.status == "200") {
                        for (let i = 0; i < _json.length; i++) {
                            //console.log(_json[i]);
                            _json[i]["f_Cycle"] = $("#readCycle").val().replaceAll("-", "");
                            yield _xLib.AJAX_Post("/api/KBNMS008/SelectDateChange?isImport=true", JSON.stringify(_json[i]), function (success) {
                                return __awaiter(this, void 0, void 0, function* () {
                                    if (success.status == "200") {
                                        success = _xLib.JSONparseMixData(success);
                                        //console.log(success.data);
                        ...
                        yield _xLib.AJAX_Post("/api/KBNMS008/UploadImportToKanbanPlan", "", function (success) {
                            if (success.status == "200") {
                                xSplash.hide();
