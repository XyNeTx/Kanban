...
function List_Data() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get("/api/KBNMS016/List_Data", getObj, function (success) {
...
function GetSupplierDetail() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        getObj.F_Ruibetsu = getObj.F_Part_No !== "" ? getObj.F_Part_No.split("-")[1] : "";
        getObj.F_Part_No = getObj.F_Part_No !== "" ? getObj.F_Part_No.split("-")[0] : "";
        _xLib.AJAX_Get("/api/KBNMS016/GetSupplierDetail", getObj, function (success) {
...
function GetPartNoDetail() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        getObj.F_Ruibetsu = getObj.F_Part_No !== "" ? getObj.F_Part_No.split("-")[1] : "";
        getObj.F_Part_No = getObj.F_Part_No !== "" ? getObj.F_Part_No.split("-")[0] : "";
        _xLib.AJAX_Get("/api/KBNMS016/GetPartNoDetail", getObj, function (success) {
            success.data = _xLib.TrimJSON(success.data);
            console.log(success);
...
function Save() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //return;
        _xLib.AJAX_Post("/api/KBNMS016/Save?action=" + action, listObj, function (success) {
...
function GetDropDown() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        getObj.F_Part_No = getObj.F_Part_No !== "" ? getObj.F_Part_No.split("-")[0] : "";
        getObj.action = action;
        _xLib.AJAX_Get("/api/KBNMS016/GetDropDown", getObj, function (success) {
            //console.log(success);
            if ($("#F_Supplier_Cd").val() === "")
                $("#F_Supplier_Cd").addListSelectPicker(success.data.supplier, "f_Supplier_Cd");
            if ($("#F_Kanban_No").val() === "")
            ...
            if ($("#F_Group").val() === "")
                $("#F_Group").addListSelectPicker(success.data.group, "f_Group");
        });
    });
}
