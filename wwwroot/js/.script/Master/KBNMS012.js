...
$("#F_Supplier_Code2").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
...
function GetDropDown() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //console.log(obj);
        yield _xLib.AJAX_Get("/api/KBNMS012/GetDropDown", obj, function (success) {
            success.data = _xLib.TrimArrayJSON(success.data);
            if ($("#F_Supplier_Code").val() === "")
                $("#F_Supplier_Code").addListSelectPicker(success.data.supcode, "f_Supplier_Code");
            if ($("#F_Supplier_Code2").val() === "")
                $("#F_Supplier_Code2").addListSelectPicker(success.data.supcode, "f_Supplier_Code");
            if ($("#F_Kanban_No").val() === "")
                $("#F_Kanban_No").addListSelectPicker(success.data.kanban, "f_Kanban_No");
            if ($("#F_Store_Cd").val() === "")
                $("#F_Store_Cd").addListSelectPicker(success.data.store, "f_Store_Cd");
            if ($("#F_Store_Cd2").val() === "")
                $("#F_Store_Cd2").addListSelectPicker(success.data.store, "f_Store_Cd");
            if ($("#F_Part_No").val() === "")
                $("#F_Part_No").addListSelectPicker(success.data.partno, "f_Part_No");
            //return console.log("GetDropDown");
        }, function (error) {
            if ($("#F_Supplier_Code").val() === "")
                $("#F_Supplier_Code").removeListSelectPicker();
            if ($("#F_Supplier_Code2").val() === "")
                $("#F_Supplier_Code2").removeListSelectPicker();
            if ($("#F_Kanban_No").val() === "")
                $("#F_Kanban_No").removeListSelectPicker();
            if ($("#F_Store_Cd").val() === "")
                $("#F_Store_Cd").removeListSelectPicker();
            if ($("#F_Store_Cd2").val() === "")
                $("#F_Store_Cd2").removeListSelectPicker();
            if ($("#F_Part_No").val() === "")
                $("#F_Part_No").removeListSelectPicker();
        });
    });
}
function GetSupplierDetail() {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = yield GetObj();
        _xLib.AJAX_Get("/api/KBNMS012/GetSupplierDetail", obj, function (success) {
            success.data = _xLib.TrimArrayJSON(success.data);
            console.log(success);
        });
    });
...
function Search() {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = yield GetObj();
        _xLib.AJAX_Get("/api/KBNMS012/Search", obj, function (success) {
            success.data = _xLib.TrimArrayJSON(success.data);
            console.log(success);
...
function FindDetail() {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = yield GetObj();
        yield _xLib.AJAX_Get("/api/KBNMS012/FindDetail", obj, function (success) {
...
function Save() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(listObj);
        _xLib.AJAX_Post("/api/KBNMS012/Save", obj, function (success) {
