...
function GetDropDownList() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get("/api/KBNMS020/GetDropDownList", getObj, function (success) {
...
function GetSupplierName() {
    return __awaiter(this, void 0, void 0, function* () {
        var getObj = yield ObjGet();
        _xLib.AJAX_Get("/api/KBNMS020/GetSupplierName", getObj, function (success) {
...
function GetQtyBox() {
    return __awaiter(this, void 0, void 0, function* () {
        var getObj = yield ObjGet();
        _xLib.AJAX_Get("/api/KBNMS020/GetQtyBox", getObj, function (success) {
            success.data = _xLib.TrimJSON(success.data);
            console.log(success);
...
function GetPartName() {
    return __awaiter(this, void 0, void 0, function* () {
        var getObj = yield ObjGet();
        _xLib.AJAX_Get("/api/KBNMS020/GetPartName", getObj, function (success) {
            success.data = _xLib.TrimJSON(success.data);
            console.log(success);
...
function GetListData() {
    return __awaiter(this, void 0, void 0, function* () {
        var getObj = yield ObjGet();
        _xLib.AJAX_Get("/api/KBNMS020/GetListData", getObj, function (success) {
...
function Save() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Post("/api/KBNMS020/Save?action=" + action, listObj, function (success) {
            GetListData();
