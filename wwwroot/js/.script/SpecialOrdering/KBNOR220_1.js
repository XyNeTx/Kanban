...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield LoadColorofTag();
        yield InitialScreenCmb();
        yield LoadSurveyDoc();
        xSplash.hide();
    });
});
function LoadColorofTag() {
    _xLib.AJAX_Get("/api/KBNOR220/LoadColorofTag", null, function (success) {
...
function LoadSurveyDoc() {
    _xLib.AJAX_Get("/api/KBNOR220_1/LoadSurveyDoc", null, function (success) {
        success = _xLib.JSONparseMixData(success);
        //console.log(success);
        $("#selSurveyDoc").empty();
...
function InitialScreenCmb() {
    _xLib.AJAX_Get("/api/KBNOR220/InitialScreenCmb", null, function (success) {
        success = _xLib.JSONparseMixData(success);
        //console.log(success);
...
$("#selSurveyDoc").change(SurveyDocChanged = () => __awaiter(void 0, void 0, void 0, function* () {
    let data = {
        surveyDoc: $("#selSurveyDoc").val(),
    };
    _xLib.AJAX_Get("/api/KBNOR220_1/LoadSurveyDoc", data, (success) => __awaiter(void 0, void 0, void 0, function* () {
        success = _xLib.JSONparseMixData(success);
        console.log(success);
...
let mode;
$("#btnInq").click(InqClicked = () => __awaiter(void 0, void 0, void 0, function* () {
    mode = "inquiry";
...
$("#btnUpd").click(UpdClicked = () => __awaiter(void 0, void 0, void 0, function* () {
    mode = "update";
...
$("#btnDel").click(DelClicked = () => __awaiter(void 0, void 0, void 0, function* () {
    mode = "delete";
    let data = {
        mode: mode
    };
...
$("#btnCan").click(CanClicked = () => __awaiter(void 0, void 0, void 0, function* () {
...
$("#btnSave").click(SaveClicked = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    _xLib.AJAX_Post("/api/KBNOR220_1/Save?isDel=" + isDel, listObj, (success) => __awaiter(void 0, void 0, void 0, function* () {
