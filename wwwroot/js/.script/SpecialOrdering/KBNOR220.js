...
function LoadListView() {
    _xLib.AJAX_Get("/api/KBNOR220/LoadListView", null, function (success) {
...
$("#btnSave").click(function () {
    ...
    console.log(data);
    _xLib.AJAX_Post("/api/KBNOR220/Save", data, function (success) {
        return __awaiter(this, void 0, void 0, function* () {
...
$("#btnGen").click(function () {
    ...
    _xLib.AJAX_Post("/api/KBNOR220/Generate", data, function (success) {
        return __awaiter(this, void 0, void 0, function* () {
            yield xSwal.success(success.response, success.message);
