...
function SupplierDropDown(isNew) {
    ...
    _xLib.AJAX_Get("/api/KBNOR296/SupplierDropDown", obj, function (success) {
...
$("#inpSupplier").change(function SupplierChanged() {
    ...
    _xLib.AJAX_Get("/api/KBNOR296/SupplierChanged", obj, function (success) {
        success = _xLib.JSONparseMixData(success);
        console.log(success);
    ...
    if (activedBtn == "btnNew")
        return;
    _xLib.AJAX_Get("/api/KBNOR296/ListData", obj, function (success) {
        success = _xLib.JSONparseMixData(success);
        //console.log(success);
...
$("#btnSave").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (activedBtn == "btnDel") {
            ...
            if (yield xSwal.confirm("Are you sure", "This action cannot be undone.")) {
                Save("Delete", obj);
            }
        }
...
function Save(Action, Obj) {
    _xLib.AJAX_Post("/api/KBNOR296/Save?Action=" + Action, Obj, function (success) {
...
$("#btnReport").click(function () {
    ...
    _xLib.OpenReportObj("/KBNOR296", obj);
});
