...
$("#inpExPONoFrom").change(() => __awaiter(void 0, void 0, void 0, function* () {
    yield $("#inpExPONoTo").val($("#inpExPONoFrom").val());
    yield ExGetPDS();
}));
$('#inpExPONoTo').change(() => __awaiter(void 0, void 0, void 0, function* () {
    yield ExGetPDS();
}));
$("#inpExPDSNoFrom").change(() => __awaiter(void 0, void 0, void 0, function* () {
    yield $("#inpExPDSNoTo").selectpicker("val", $("#inpExPDSNoFrom").val());
}));
...
//    await ExExportData();
//});
$("#btnPDS").click(() => __awaiter(void 0, void 0, void 0, function* () {
    yield Preview();
}));
$("#btnPart").click(() => __awaiter(void 0, void 0, void 0, function* () {
    yield PreviewKB();
}));
//ExGetSupplier = async () => {
...
Preview = (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(data);
    _xLib.AJAX_Post(`/api/KBNOR270/Preview`, data, (success) => __awaiter(void 0, void 0, void 0, function* () {
        console.log(success);
        ...
        yield window.open(link, "_blank");
    }), (error) => __awaiter(void 0, void 0, void 0, function* () {
        xSwal.xError(error);
    }));
});
PreviewKB = (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    _xLib.AJAX_Get(`/api/KBNOR270/PreviewKB`, null, (success) => __awaiter(void 0, void 0, void 0, function* () {
        console.log(success);
        yield xSwal.success(success.response, success.message);
