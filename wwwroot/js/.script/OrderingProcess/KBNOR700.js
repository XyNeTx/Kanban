...
$(document).ready(function () {
                ...
                yield xAjax.Post({
                    ...
                    then: function (result) {
                        ...
                        if (_xLib.GetCookie('isDev') == "1") {
                            window.open(_REPORTINGSERVER_ + '%2fKB3%2fKBNOR700PDS_X2&rs:Command=Render'
                                + '&pUserCode=' + ajexHeader.UserCode
                                ...
                                + '&F_Plant=' + ajexHeader.Plant, '_blank');
                        }
                        else {
                            window.open(_REPORTINGSERVER_ + '%2fKB3%2fKBNOR700PDS&rs:Command=Render'
                                + '&pUserCode=' + ajexHeader.UserCode
                                + '&OrderNo=' + ($('#chkPDSNo').val() == 1 ? itmPDS.value : '')
                                + '&OrderNoTo=' + ($('#chkPDSNo').val() == 1 ? itmPDSTo.value : '')
                                + '&DeliveryDate=' + ($('#chkDeliveryDate').val() == 1 ? ReplaceAll(itmDelivery.value, '-', '') : '')
    ...
    printKANBAN = function () {
        return __awaiter(this, arguments, void 0, function* (pRPTNAME = 'KBNOR700KANBAN') {
                    ...
                    then: function (result) {
                        ...
                        if (_xLib.GetCookie('isDev') == "1") {
                            ...
                            window.open(_REPORTINGSERVER_ + '%2fKB3%2f' + pRPTNAME + '&rs:Command=Render'
                                ...
                                + '&DeliveryDate=' + ($('#chkDeliveryDate').val() == 1 ? ReplaceAll(itmDelivery.value, '-', '') : '')
                                + '&DeliveryDateTo=' + ($('#chkDeliveryDate').val() == 1 ? ReplaceAll(itmDeliveryTo.value, '-', '') : ''), '_blank');
                        }
                    }
                });
                xSplash.hide();
...
xAjax.onChange('#rdoOrderTypeNormal', function () {
    return __awaiter(this, void 0, void 0, function* () {
        rdoOrderType.check = 'Normal';
        loadOrderType();
    });
});
xAjax.onChange('#rdoOrderTypeSpecial', function () {
    return __awaiter(this, void 0, void 0, function* () {
        rdoOrderType.check = 'Special';
        loadOrderType();
    });
});
xAjax.onChange('#rdoOrderTypeUrgent', function () {
    return __awaiter(this, void 0, void 0, function* () {
        rdoOrderType.check = 'Urgent';
        loadOrderType();
    });
