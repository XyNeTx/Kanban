...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield $("table thead tr th").addClass("text-center");
        yield $("table body tr td").addClass("text-center");
        yield _xLib.AJAX_Get("/api/KBNOR470/List_Data", '', function (success) {
...
$("#btnUnlock").click(function () {
    ...
    //console.log(listObj);
    _xLib.AJAX_Post("/api/KBNOR470/Unlock", JSON.stringify(listObj), function (success) {
        if (success.status == 200) {
