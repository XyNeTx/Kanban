...
function GetDropDownData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return _xLib.AJAX_Get("/api/KBNOR321/GetDropDownData", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                console.log(success);
...
$("#btnPrevPage").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Get_All_Data(action, _IntRow);
        window.scrollTo(0, 0);
    });
});
$("#btnNextPage").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var page = parseInt($("#txtPage").val().split("/")[0]) + 1;
        if (page == parseInt($("#txtPage").val().split("/")[1]) + 1)
            return;
        _IntRow = (page - 1);
        $("#txtPage").val(page.toString() + "/" + dT_PartControl.length.toString());
        yield Get_All_Data(action, _IntRow);
...
$("#btnProcess").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _IntRow = 0;
        yield Get_All_Data("Process", _IntRow);
...
$("#btnPreview").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _IntRow = 0;
        yield Get_All_Data("Preview", _IntRow);
    });
});
...
$("#btnBlCal").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield Recalculate("Re-Calculate BL", _IntRow);
    });
});
$("#btnReCal").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield Recalculate("Re-Calculate", _IntRow);
    });
});
function GetSelectObject(action) {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = {
            action: action,
            F_Supplier_Code: $("#inputSupplier").val(),
...
function Get_All_Data(action, intRow) {
    return __awaiter(this, void 0, void 0, function* () {
        xSplash.show("Loading CKD Data");
        let obj = yield GetSelectObject(action);
        return _xLib.AJAX_Get("/api/KBNOR321/Get_All_Data", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield Set_Dynamic_Table();
                yield Set_Data(intRow);
                yield Detail_Data(intRow);
                yield EditTableStyle(action);
                yield GetInformNews();
                xSplash.hide();
            });
        }, function (error) {
...
function Set_Dynamic_Table() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        dT_Period.forEach(function (e, i) {
            ...
            if (e.Row_Num == "1")
                $("#THeadR2").append(`<th class='tempHead text-danger' id='thDay_${e.Date_Now}' style='background-color:#fba8a1;' >Day</th>`);
            else
                $("#THeadR2").append(`<th class='tempHead' id='thNight_${e.Date_Now}' style='background-color:#86b6fd;color:#001eff'>Night</th>`);
...
function Set_Data(intRow) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let j = 0; j < dT_Period.length; j++) {
            try {
                ...
                x.F_Process_Date == dT_Period[j].Date_Now &&
                    x.F_Process_Shift == (dT_Period[j].Row_Num == "1" ? "D" : "N"))[0];
                ...
                x.F_Process_Date == dT_Period[j].Date_Now &&
                    ...
                    x.F_Process_Round == dT_Period[j].Row_Num)[0];
                ...
                x.F_Delivery_Date == dT_Period[j].Date_Now &&
                    //x.F_Process_Shift == (dT_Period[j].Row_Num == "1" ? "D" : "N") &&
                    x.F_Delivery_Round == dT_Period[j].Row_Num)[0];
                ...
                yield GetBL(dT_Period[j].Date_Now, dT_Period[j].Row_Num, intRow);
                //console.log(headData);
        ...
        var findHeadData = dT_Header.filter(x => x.F_Supplier_Code == dT_PartControl[intRow].F_Supplier_Code &&
            x.F_Supplier_Plant == dT_PartControl[intRow].F_Supplier_Plant &&
            x.F_Part_No == dT_PartControl[intRow].F_Part_No &&
            x.F_Ruibetsu == dT_PartControl[intRow].F_Ruibetsu &&
            x.F_Store_Code == dT_PartControl[intRow].F_Store_Code &&
            ...
            x.F_Process_Shift == $("#inputProcessShiftFor").val())[0];
...
function GetBL(strDate, Row_Num, intRow) {
    return __awaiter(this, void 0, void 0, function* () {
        let obj = {
            strDate: strDate,
            Row_Num: Row_Num,
        ...
        return _xLib.AJAX_Get("/api/KBNOR321/GetBL", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                console.log(success);
...
function Onload() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return _xLib.AJAX_Get("/api/KBNOR321/Onload", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                success = _xLib.JSONparseMixData(success);
                console.log(success);
...
function GetInformNews() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return _xLib.AJAX_Get("/api/KBNOR321/GetInformNews", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                //success = _xLib.JSONparseMixData(success);
                console.log(success);
...
function Detail_Data(intRow) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return _xLib.AJAX_Get("/api/KBNOR321/Detail_Data", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                console.log(success);
...
function Recalculate(action, intRow) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return _xLib.AJAX_Get("/api/KBNOR321/Recalculate", obj, function (success) {
            return __awaiter(this, void 0, void 0, function* () {
                console.log(success);
                yield Get_All_Data(_ProcessAction, intRow);
                xSplash.hide();
            });
        });
    });
}
function EditTableStyle(action) {
    return __awaiter(this, void 0, void 0, function* () {
