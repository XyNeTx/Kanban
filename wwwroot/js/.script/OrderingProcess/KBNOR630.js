...
$(document).ready(function () {
    ...
    xAjax.onClick('btnSearch', function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (_dt.rows != null)
                    MsgBox(`ไม่สามารถ Delete PDS นี้ได้ เพราะ PDS นี้ถูก Delete ไปแล้ว!!!`, MsgBoxStyle.Critical);
    ...
    xAjax.onClick('btnDelete', function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                MsgBox(`Do you want Delete URGENT PDS Data?`, MsgBoxStyle.OkCancel, function () {
                    return __awaiter(this, void 0, void 0, function* () {
