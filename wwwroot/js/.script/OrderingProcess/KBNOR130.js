...
$(document).ready(function () {
    ...
    xAjax.onClick('btnGenerate', function () {
        return __awaiter(this, void 0, void 0, function* () {
            MsgBox("Do you want Issued PDS Normal Data?", MsgBoxStyle.OkCancel, function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (_dt.rows == null)
                        MsgBox("ไม่พบข้อมูล PDS Normal Order", MsgBoxStyle.Information, "Generate Normal Data");
