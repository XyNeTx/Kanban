...
$(document).ready(function () {
    ...
    xAjax.onClick('btnCalculate', function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                MsgBox("Do you want Calculate Order for Urgent?", MsgBoxStyle.OkCancel, function () {
                    return __awaiter(this, void 0, void 0, function* () {
    ...
    $("#btnReport").click(function () {
        ...
        _xLib.OpenReport('/KBNOR420', `UserCode=${ajexHeader.UserCode}&Plant=${ajexHeader.Plant}&UserName=${UserName}`);
    });
});
