...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNIM012/Onload", null, function (success) {
...
function GetSupplier() {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetSupplier", obj, function (success) {
        if (success.status == "200") {
...
function GetKanban() {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetKanban", obj, function (success) {
        if (success.status == "200") {
            success = _xLib.JSONparseAndTrim(success);
            console.log(success);
            $("#selectKanban").empty();
...
function GetStore() {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetStore", obj, function (success) {
        if (success.status == "200") {
            success = _xLib.JSONparseAndTrim(success);
            console.log(success);
            $("#selectStore").empty();
...
function GetStore2nd() {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetStore2nd", obj, function (success) {
        if (success.status == "200") {
            success = _xLib.JSONparseAndTrim(success);
            console.log(success);
...
function GetPart() {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetPart", obj, function (success) {
        if (success.status == "200") {
            success = _xLib.JSONparseAndTrim(success);
            console.log(success);
            $("#selectPart").empty();
...
function GetListData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _xLib.AJAX_Get("/api/KBNIM012/GetListData", obj, function (success) {
            if (success.status == "200") {
                success = _xLib.JSONparseAndTrim(success);
                console.log(success);
...
$("#selectSupplier").change(function () {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetSupplierDetail", obj, function (success) {
        if (success.status == "200") {
            console.log(success);
...
$("#selectKanban").change(function () {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetKanbanDetail", obj, function (success) {
        if (success.status == "200") {
            console.log(success);
...
$("#selectStore").change(function () {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetStoreDetail", obj, function (success) {
        if (success.status == "200") {
            console.log(success);
...
$("#selectPart").change(function () {
    var obj = ObjGet();
    _xLib.AJAX_Get("/api/KBNIM012/GetPartDetail", obj, function (success) {
        if (success.status == "200") {
            console.log(success);
...
$("#btnInterface").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield _xLib.AJAX_Get("/api/KBNIM012/CheckBeforeInterface", null, function (success) {
            if (success.status == "200") {
                console.log(success);
...
function InterfaceData() {
    ...
    _xLib.AJAX_Post("/api/KBNIM012/Interface", JSON.stringify(obj), function (success) {
        if (success.status == "200") {
            console.log(success);
            GetListData();
            xSwal.success("Success !!", success.message);
...
function CheckInterfaceN1() {
    _xLib.AJAX_Post("/api/KBNIM012/CheckInterfaceN1", null, function (success) {
        if (success.status == "200") {
...
function InterfaceN1() {
    _xLib.AJAX_Post("/api/KBNIM012/InterfaceN1", null, function (success) {
        if (success.status == "200") {
            console.log(success);
            xSwal.success("Success !!", success.message);
        }
