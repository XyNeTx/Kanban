    ...
    initial = function () {
        return __awaiter(this, void 0, void 0, function* () {
            var tblMenu = xDataTable.Initial({
                ...
                eventclick: (data, r, c, e) => __awaiter(this, void 0, void 0, function* () {
                    //console.log(data);
                    ...
                    //console.log(_dt);
                    if (_dt.rows != null)
                        xDataTable.bind('#tblMenu', _dt.rows);
                    if (_dt.rows != null) {
                        for (var i = 0; i < _dt.rows.length; i++) {
                            if (_dt.rows[i].isCheck == 1)
                                $('#tblMenu_SELECTALL_' + (i + 1)).attr('checked', 'checked');
                        }
                    }
                }),
