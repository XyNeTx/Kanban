...
$(document).ready(function (e, context) {
    ...
    if ((_debug == undefined) || (_debug == ''))
        setCookie('debug', '0');
    if (_debug != 1)
        $('#_SYSTEMHISTORY_').attr('style', 'visibility:hidden;display:none;');
    if (_debug != 1)
        $('#_SYSTEMHISTORYMENU_').attr('style', 'visibility:hidden;display:none;');
    ...
    $('#ButtonLayoutExport_CSV').on("mousedown", function () {
        xSwal.questionPack(_i18n_._Layout.export.swal_csv, function () {
    ...
    $('#ButtonLayoutExport_XLS').on("mousedown", function () {
        xSwal.questionPack(_i18n_._Layout.export.swal_xls, function () {
    ...
    $('#ButtonLayoutExport_PDF').on("mousedown", function () {
        xSwal.questionPack(_i18n_._Layout.export.swal_pdf, function () {
    ...
    styleSelector = function (_i18n_) {
        ...
        $.each(_i18n_.styleSelector.ExpandIconOption, function (e, v) {
            ...
            if (e == getCookie('UI_ExpandIcon'))
                $('#vertical-dropdown-icon option[value=' + e + ']').attr('selected', 'selected');
        });
        $.each(_i18n_.styleSelector.MenuIconOption, function (e, v) {
            $('#vertical-subitem-icon option[value=' + e + ']').text(v);
            if (e == getCookie('UI_MenuIcon'))
                $('#vertical-subitem-icon option[value=' + e + ']').attr('selected', 'selected');
        });
        $.each(_i18n_.styleSelector.SideBarOption, function (e, v) {
            $('#vertical-menu-effect option[value=' + e + ']').text(v);
            if (e == getCookie('UI_SideBar'))
                $('#vertical-menu-effect option[value=' + e + ']').attr('selected', 'selected');
        });
        $('[name="radio"][value="st6"]').attr('checked', 'true');
        if (getCookie('UI_IconColor') == 'st5')
            $('[name="radio"][value="st5"]').attr('checked', 'true');
    };
    ...
    $('#vertical-menu-effect').on('click', function () {
        return __awaiter(this, void 0, void 0, function* () {
            changeLayOut('SideBar', $(this).val());
        });
    });
    $('[name="radio"][value="st6"]').on('click', function () {
        return __awaiter(this, void 0, void 0, function* () {
            changeLayOut('IconColor', $(this).val());
        });
    });
    $('[name="radio"][value="st5"]').on('click', function () {
        return __awaiter(this, void 0, void 0, function* () {
            changeLayOut('IconColor', $(this).val());
        });
    });
    changeLayOut = function () {
        return __awaiter(this, arguments, void 0, function* (pObject = '', pValue = 'theme1') {
            setCookie('UI_' + pObject, pValue);
            if (pObject == 'Header')
                setCookie('UI_HeaderBrand', pValue);
