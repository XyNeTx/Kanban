...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (yield (_xLib.GetCookie("isDev") == null || _xLib.GetCookie("isDev") == ""))
        ...
        initial = function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield $.ajax({
                    ...
                    success: function (result) {
                        if (_xLib.GetCookie("isDev") == '1')
                            $('h4').append('<h5 class="mt-3">DEVELOPER MODE</h5>');
                        //console.log(result);
                        $("#txtProcessDate").prop('disabled', true);
                        $("#ddlShift").prop('disabled', true);
                ...
                yield _xLib.AJAX_GetNoHeader(`/xapi/GetLoginDate`, '', function (success) {
                    //console.log(success);
