...
$(document).ready(function () {
    const xKBNIM015M = new ActionTemplate({
        Controller: _PAGE_,
        Form: 'frmCondition'
    });
    xKBNIM015M.prepare(function () {
    ...
    onExecute = function () {
        xKBNIM015M.execute(function () {
            console.log('onExecute');
        });
    };
    onDeleteAll = function () {
        xKBNIM015M.delete(function () {
    ...
    _setDayInMonth = function () {
        ...
        if (_row6 == 0)
            $('#row6').attr('style', 'visibility:hidden;display:none;');
        //console.log(_row6);
    };
    _setDayInMonth();
