...
$(document).ready(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Get("/api/KBNMT110/GetUser", null, function (success) {
        ...
        yield _xLib.AJAX_Get("/api/KBNMT110/GetMenu", "", function (success) {
...
$("#inpUserCode").change(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        $("#inpUserID").remove();
        $("#inpUserName").val("");
        _xLib.AJAX_Get("/api/KBNMT110/GetUserDetailAndAuth", { User_Code: $("#inpUserCode").val() }, function (success) {
            console.log(success);
...
$("#btnSave").click(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _xLib.AJAX_Post("/api/KBNMT110/SetUserAuthorize", JSON.stringify(listObj), function (success) {
