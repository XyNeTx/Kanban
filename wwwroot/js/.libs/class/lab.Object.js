...
class Label {
    constructor(pID) {
        this.label = function (plabel = '') {
            if (plabel != '')
                this.property.label = plabel;
            if (plabel != '')
...
class TextBox {
    ...
    set value(Value) {
        ...
        if (this.property.type == 'date')
            this.property.value = $('#' + this.id).val();
        if (this.property.type == 'time')
            this.property.value = $('#' + this.id).val();
        if (this.property.type == 'month')
            this.property.value = $('#' + this.id).val();
    ...
    set readonly(Value) {
        ...
        if (this.property.readonly)
            $('#' + this.id).attr('readonly', this.property.readonly);
        if (!this.property.readonly)
