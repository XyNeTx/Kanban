class libAPI {
    ...
    initial(pURL = null) {
        ...
        if (this.getCookie('debug') == '1') console.log(this.url + '/ad/?tid=' + this.token);
    ...
    getUser(pConfig = null) {
        ...
        if (this.getCookie('debug') == '1') console.log(ajexHeader);
        ...
        if (this.getCookie('debug') == '1') console.log(_url);
