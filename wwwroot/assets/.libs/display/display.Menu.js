...
$(document).ready(function () {
    ...
    if (_CONTROLLER_ + _PAGE_ !='HomeIndex') $('#mCSB_1_container').attr('style', 'position: relative; top: -' + document.getElementById(_CONTROLLER_ + _PAGE_).offsetTop + 'px; left: 0px; width: 100%;');   
