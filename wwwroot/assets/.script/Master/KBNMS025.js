...
async function GetLogisticSupplier() {
    let obj = {
        TruckType: $("#inpTruckType").val(),
    }

    _xLib.AJAX_Get("/api/KBNMS025/GetLogisticSupplier", obj,
        function (success) {
...
async function GetTruckType() {
    let obj = {
        Logistic: $("#inpSupplierCode").val(),
        isNew: !$("#btnNew").prop("disabled"),
    }

    _xLib.AJAX_Get("/api/KBNMS025/GetTruckType", obj,
        function (success) {
...
async function TruckTypeSelected() {
    let obj = {
        TruckType: $("#inpTruckType").val(),
        isNew: !$("#btnNew").prop("disabled"),
        Logistic: $("#inpSupplierCode").val(),
    ...
    _xLib.AJAX_Get("/api/KBNMS025/TruckTypeSelected", obj,
        function (success) {
            success = _xLib.JSONparseMixData(success);
            console.log(success);
...
async function GetListData() {
    ...
    _xLib.AJAX_Get("/api/KBNMS025/GetListData", obj,
        function (success) {
            success = _xLib.JSONparseMixData(success);
...
async function Save()
{
    ...
    _xLib.AJAX_Post("/api/KBNMS025/Save?action=" + actionQ, listObj,
        function (success) {
