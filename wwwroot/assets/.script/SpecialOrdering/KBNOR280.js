...
$(document).on("show.bs.modal", "#KBNOR280_EX", async () => {
...
ExExportData = async () => {
    ...
    _xLib.AJAX_Get("/api/KBNOR280/ExportData", GetQuery,
        async (success) => {
            success = _xLib.JSONparseMixData(success);
            console.log(success);
            await ExXLSXjsonToCSV(success.data);
        }
    );

};

ExXLSXjsonToCSV = async (data) => {
