...
function SupplierDropDown(isNew)
{
    ...
    _xLib.AJAX_Get("/api/KBNOR296/SupplierDropDown", obj,
        function (success) {
...
$("#inpSupplier").change(function SupplierChanged () {
    ...
    _xLib.AJAX_Get("/api/KBNOR296/SupplierChanged", obj,
        function (success) {
            success = _xLib.JSONparseMixData(success);
            console.log(success);
    ...
    _xLib.AJAX_Get("/api/KBNOR296/ListData", obj,
        function (success) {
            success = _xLib.JSONparseMixData(success);
            //console.log(success);
...
function Save(Action, Obj) {
    ...
    _xLib.AJAX_Post("/api/KBNOR296/Save?Action=" + Action, Obj,
        function (success) {
