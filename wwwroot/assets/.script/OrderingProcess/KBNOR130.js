$(document).ready(function () {
    ...
    ProcessSpecialKPO = async function () {   //'incase S
        ...
        if (_dtChk.rows != null) {
            for (var i = 0; i < _dtChk.rows.length; i++) {
                ...
                await xAjax.Execute({
                    data: {
                        "Module": "[exec].[spKBNOR130_07_I_DT]",
                        "@pOrderType": "N",
                        "@pPlant": ajexHeader.Plant,
                        "@pUserCode": ajexHeader.UserCode,
                        "@PDS_No": pdsno,
    ...
    ProcessSpecialEmer = async function () {   //'Incase Others
        ...
        if (_dtChk.rows != null) {
            for (var i = 0; i < _dtChk.rows.length; i++) {
                ...
                await xAjax.Execute({
                    data: {
                        "Module": "[exec].[spKBNOR130_09_I_DT]",
                        "@pOrderType": "N",
                        "@pPlant": ajexHeader.Plant,
                        "@pUserCode": ajexHeader.UserCode,
                        "@PDS_No": pdsno,
    ...
    ProcessOrderTacoma = async function (TypePart_, TypeSpc_) {    //''Assy
        ...
        if (_dtChk.rows != null) {
            for (var i = 0; i < _dtChk.rows.length; i++) {
                ...
                await xAjax.Execute({
                    data: {
                        "Module": "[exec].[spKBNOR130_10_I_DT]",
                        "@pOrderType": "N",
                        "@pPlant": ajexHeader.Plant,
                        "@pUserCode": ajexHeader.UserCode,
                        "@PDS_No": pdsno,
    ...
    ProcessOrderWareHouse = async function () {   //'Incase Tacoma Project 
        ...
        if (_dtChk.rows != null) {
            for (var i = 0; i < _dtChk.rows.length; i++) {
                ...
                await xAjax.Execute({
                    data: {
                        "Module": "[exec].[spKBNOR130_11_I_DT]",
                        "@pOrderType": "N",
                        "@pPlant": ajexHeader.Plant,
                        "@pUserCode": ajexHeader.UserCode,
                        "@PDS_No": pdsno,
    ...
    GetDate = async function (delivery_) {
        ...
        var _dtChk = await xAjax.ExecuteJSON({
            data: {
                "Module": "[exec].[spKBNOR130_GetDate]",
