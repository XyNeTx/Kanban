...
{
    [Table("TB_Slide_Order", Schema = "dbo")]
    [PrimaryKey("F_Plant", "F_Supplier_CD", "F_Supplier_Plant", "F_Store_CD", "F_Delivery_Date", "F_Delivery_Trip")]
    public class TB_Slide_Order
    {
