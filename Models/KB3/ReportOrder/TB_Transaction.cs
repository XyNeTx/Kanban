...
namespace KANBAN.Models.KB3.ReportOrder
{
    ...
    public class TB_Transaction
    {
        ...
        public required string F_Process_By { get; set; }
        public required string F_Process_Date { get; set; }
        public char F_Process_Shift { get; set; }
        public string? F_Remark { get; set; }
        public required string F_HMMT_PDS { get; set; }
        public required string F_Survey_Doc { get; set; }
        ...
        public required string F_Freight { get; set; }
