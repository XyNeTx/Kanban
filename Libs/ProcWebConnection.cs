...
{
    public class ProcWebConnection
    {
        ...
        public ProcWebConnection(IConfiguration configuration)
        {
            _configuration = configuration;
            _connectionStirng = _configuration.GetValue<string>("ConnectionStrings:ProcWebConnection");
        }
