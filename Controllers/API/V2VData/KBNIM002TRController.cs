...
{
    public class KBNIM002TRController : Controller
    {
...
";
    ...
    Sql = Sql & )S INNER JOIN(Select * from dbo.TMP_PARENTS_CHILD Where F_Update_BY = '" + User.FindFirst(ClaimTypes.UserData).Value.ToString() + @"')P ON
