...
{
    public class ERP01M010Controller : Controller
    {
        ...
        public IActionResult save()
        {
            ...
            try
            {
                ...
                DataTable _dtUser = _KBCN.ExecuteSQL(_SQL);
                ...
                if (_dtUser != null)
                {
                    ...
                    erpGroupUser _erpGroupUser = new erpGroupUser();
                    _erpGroupUser.System_ID = 4;
                    _erpGroupUser.User_ID = int.Parse(_dtUser.Rows[0]["MaxID"].ToString());
                    ...
                    _ERPContext.erpGroupUser.Add(_erpGroupUser);
