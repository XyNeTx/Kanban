    ...
    public class KBNMS016Controller : Controller
    {
        ...
        public IActionResult initial([FromBody] string pData = null)
        {
            ...
            try
            {
                ...
                string _jsTB_Group = _KBCN.executeJSON(_SQL, pUser: _JBearer, pControllerName : ControllerContext.ActionDescriptor.ControllerName, pActionName: ControllerContext.ActionDescriptor.ActionName);
        ...
        public IActionResult search([FromBody] string pData = null)
        {
            ...
            try
            {
                ...
                _SQL = @" EXEC [exec].[spKBNMS016_SEARCH] '" + _JBearer.Plant + "' ";
